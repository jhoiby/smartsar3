...
While this project is currently a "monolith" due to the single distribution package and mostly synchronous 
operation, this project is carefully organized to prevent coupling between the bounded contexts. However,
to save development effort some universally-used code has been saved in a "common" project.

Keeping in mind that this program may be broken up into microservices in the future, and for ease of maintenance, the 
code in the common folder is contained in folders that are candidates to be broken into pacakges and distrubuted
